...
const { secondDB } = require('../../config/db'); // Import the rewardsDB connection

// Define the schema for the CSV format
const attendWhatsAppFollowupSchema = new mongoose.Schema({
...
const attendWhatsAppFollowup = rewardsDB.model('attendWhatsAppFollowup', attendWhatsAppFollowupSchema);

module.exports = attendWhatsAppFollowup;